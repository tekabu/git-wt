...
| `git-wt 1 diff 2 live` | Compare the files on disk, `.gitignore` honored |
| `git-wt 1 diff 2 live hunks` | Same, plus each file's changed line numbers |
| `git-wt 1 diff 2 hunks` | Line numbers on the committed diff |
| `git-wt 1 diff 2 live ..` | Error — a range compares commits, `live` compares disk |
